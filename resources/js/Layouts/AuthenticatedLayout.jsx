                ...
                <nav className="bg-yellow-600 text-white border-b border-gray-100">
                        ...
                        <div className="flex justify-between h-16">
                            ...
                            <div className="flex items-center ms-6">
                                <div className="flex items-center ms-6 mr-2 sm:mr-0">
                                    ...
                                    <div className="ms-3 items-center hidden sm:flex relative">
                                        <Dropdown>
                                            <Dropdown.Trigger>
                    ...
                    >
                        ...
                        <div className="pt-4 pb-1 border-t border-gray-200">
                            <div className="px-4">
                                <div className="font-medium text-base hover:text-gray-100">
                                    {user.name}
                                </div>
                                <div className="font-medium text-sm hover:text-gray-100">
                                    {user.email}
                                </div>
                            </div>
