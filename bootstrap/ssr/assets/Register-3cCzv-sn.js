...
import { A as AdminGuestLayout } from "./AdminGuestLayout-na7a93Lw.js";
...
import Footer from "./Footer-4Jxomgnh.js";
import "./ApplicationLogo-jQ3kBiYq.js";
function Register({ user, message }) {
  ...
  return /* @__PURE__ */ jsxs(AdminGuestLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-evenly mt-4", children: [
        /* @__PURE__ */ jsx(
          Link,
          {
