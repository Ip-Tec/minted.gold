...
import { N as NavLink, D as Dropdown, R as ResponsiveNavLink } from "./ResponsiveNavLink-IE7aM1lH.js";
import { S as Search, a as Cart } from "./Cart-S77kG9By.js";
import { A as ApplicationLogo } from "./ApplicationLogo-jQ3kBiYq.js";
import { a as CartContextProvider } from "./CartContext-32pv5l2O.js";
function Authenticated({ user, header, children }) {
  const [showingNavigationDropdown, setShowingNavigationDropdown] = useState(false);
  return /* @__PURE__ */ jsx(CartContextProvider, { children: /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-100", children: [
    /* @__PURE__ */ jsxs("nav", { className: "bg-yellow-600 text-white border-b border-gray-100", children: [
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between h-16", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center ms-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center ms-6 mr-2 sm:mr-0", children: [
            /* @__PURE__ */ jsx(Search, {}),
            /* @__PURE__ */ jsx("div", { className: "ms-3 items-center hidden sm:flex relative", children: /* @__PURE__ */ jsxs(Dropdown, { children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "pt-4 pb-1 border-t border-gray-200", children: [
              /* @__PURE__ */ jsxs("div", { className: "px-4", children: [
                /* @__PURE__ */ jsx("div", { className: "font-medium text-base hover:text-gray-100", children: user.name }),
                /* @__PURE__ */ jsx("div", { className: "font-medium text-sm hover:text-gray-100", children: user.email })
              ] }),
